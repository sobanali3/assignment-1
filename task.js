...
console.log(name.includes('Soban'));
console.log(name.startsWith('Soban'));
console.log(name.endsWith('Ali'));
console.log(name.substring(4, 9));
console.log(name.slice(-3));
console.log(name.split('n'));
console.log(name.replace('Soban', 'Mr.'));

//example of array methods
let arr = ['Soban',  'Ali', 'JavaScript', 'Developer',2025];
console.log(arr);
...
console.log(arr.unshift('Soban'));
console.log(arr.reverse());

let arr2=['comsats', 'University'];
